...
reagent-name-mango-agua-fresca = манговая вода
reagent-desc-mango-agua-fresca = Идеально подходит для любого летнего дня.
reagent-name-mango-cooler = прохладительный напиток с манго
reagent-desc-mango-cooler = Напиток для летнего вечера.
reagent-name-gunfire = ганфайр
reagent-desc-gunfire = Поднимем бокалы за смелых!
reagent-name-sidecar = коляска
reagent-desc-sidecar = Напиток, достойный армейского капитана.
reagent-name-grapesoda = виноградная кола
reagent-desc-grapesoda = Из винограда получается прекрасный напиток.
reagent-name-ice-cafe = айс-кофе
reagent-desc-ice-cafe = Кофейный смузи с чудесным ароматом.
